    ...
    private function listings(): array
    {
        return [
            [
                ...
                'region' => 'Wyoming',
                'city' => 'Casper',
                'condition' => EquipmentSubmission::CONDITION_SITTING_IDLE,
            ...
            [
                ...
                'region' => 'North Dakota',
                'city' => 'Williston',
                'condition' => EquipmentSubmission::CONDITION_RECENTLY_PULLED,
            ...
            [
                ...
                'region' => 'Colorado',
                'city' => 'Greeley',
                'condition' => EquipmentSubmission::CONDITION_RUNNING,
            ...
            [
                ...
                'region' => 'Montana',
                'city' => 'Sidney',
                'condition' => EquipmentSubmission::CONDITION_NEEDS_WORK,
