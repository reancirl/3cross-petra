...
export default function NavBar() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b border-neutral-300 bg-[#f8f8f6] shadow-[0_1px_0_rgba(255,255,255,0.7)_inset]">
            <nav
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <a
                                    ...
                                    href={item.href}
                                    aria-current={active ? 'page' : undefined}
                                    className={`border-l-2 px-3 py-2 font-heading text-base font-semibold uppercase tracking-[0.08em] transition-colors ${
                                        active
